...
class AniversarioV(EventoV):
    ...
    def incluir_evento(self) -> tuple:
        ...
        while True:
            ...
            if not mes.isdigit() or int(mes) < 1 or int(mes) > 12:
                ...
                break
        data = dia + mes
        titulo = input("\nAgora, informe o(s) nome(s) do(s)"
                       " aniversariante(s): ")
        descricao = input("\nPor fim, informe a descrição do(s)"
                          " aniversário(s): ")
        return data, titulo, descricao

    def alterar_evento(self) -> tuple:
        titulo = input("\nInforme o(s) novo(s) nome(s) do(s)"
                       " aniversariante(s): ")
        descricao = input("\nPor fim, informe a nova descrição do(s)"
                          " aniversário(s): ")
    ...
    def menu(self, chave: str) -> int:
        ...
        bar()
        opcoes = ("1 - Visualizar aniversários", "2 - Editar aniversários",
                  "3 - Excluir aniversários",
